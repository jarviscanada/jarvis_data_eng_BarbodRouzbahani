...
**Junior Developer, Jarvis (July 2022-present)**: Working on different projects using various technologies and languages such as JS, Python, Angular, Node/Express, etc.
...
**Packing Staff, Amazon (May 2021-July 2021)**: Worked as a member of the packaging section of the warehouse and helped keeping up the pace of shipping items.

**Cheff assistant, Croissant Express Cafe (September 2019-December 2019)**: Worked as a member of the kitchen and cheff assistant with tasks like cooking, cleaning, and serving food.
